...
def main():
    ...
    savings_maturity = input('Enter months:')
    ...
    print(f'The updated savings account is ${updated_savings_balance:,.2f} for {savings_maturity} months.')
    ...
    cd_maturity = input('Enter months:')
    ...
    # ADD YOUR CODE HERE
    print(f'The interest earned is ${interest_earned:,.2f}.')
    print(f'The updated CD account is ${updated_cd_balance:,.2f} for {cd_maturity} months.')
